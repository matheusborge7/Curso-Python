...
2- As tuplas são imutáveis: Isso significa que ao se criar uma tupla ele não muda. Toda
...
# OBS: Gera erro (ValueError) se colocarmos um numero diferente de elemntos para desempacotar.
